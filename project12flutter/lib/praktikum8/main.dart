...
class ApiConfig {
  static const String baseUrl =
      'https://ykqzk.wiremockapi.cloud/';// Ganti sesuai WireMock kamu
...
/// ===================================================================
/// UserPage - Halaman utama untuk GET users
/// ===================================================================
...
class _UserPageState extends State<UserPage> {
  ...
  String? errorMessage;
  String? successMessage; // Tambahkan ini untuk menampilkan hasil POST
  ...
  Future<void> addUser() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        setState(() {
          successMessage = result['message'] ?? 'User berhasil ditambahkan!';
        });
        ...
        setState(
          () =>
              successMessage = 'Gagal menambah user (${response.statusCode})',
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(
